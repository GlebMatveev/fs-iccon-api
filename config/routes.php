...
return function (App $app) {
    ...
    $app->get('/products/pack/{pack}', '\App\Modules\Products\Products:getProductsByPack');
    $app->options('/products/pack/{pack}', function (Request $request, Response $response): Response {
        return $response;
    });
    ...
    // PACKS
    $app->get('/packs', '\App\Modules\Packs\Packs:getPacks');
    $app->options('/packs', function (Request $request, Response $response): Response {
        return $response;
    });
