...
class Products
{
    ...
    public function getProducts(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $pack = empty($data["pack"]) ? "" : $data["pack"];
        ...
        if (!empty($pack)) $sqlBody .= " products.pack = '$pack' AND";
    ...
    public function getProductsByPack(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        $pack = $request->getAttribute('pack');

        $sql = "SELECT * FROM `products` WHERE pack = '$pack';";
    ...
    public function searchProducts(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        ...
        $sql = "SELECT * FROM `products` WHERE `name` LIKE '%$data[word]%' OR `developer` LIKE '%$data[word]%' OR `pack` LIKE '%$data[word]%' OR `keyword` LIKE '%$data[word]%' LIMIT 10;";
