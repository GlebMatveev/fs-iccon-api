...
class Orders
{
    ...
    {
        // Mail body
        $body = '<p><strong>new order from iccon.introlink.ru</strong></p>';
        ...
        $subject = "new request from iccon.introlink.ru";
        $from = "noreply@iccon.introlink.ru";
